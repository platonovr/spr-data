...
<c:choose>
    <c:when test="${empty userLogin}">
        <form:form method="POST" modelAttribute="activityForm"
                   action="${pageContext.request.contextPath}/activity/edit.html">
            <h2 style="color: ghostwhite"> Вы не авторизованы! </h2>
        </form:form>
    </c:when>
    <c:otherwise>
        <form:form method="POST" commandName="activityForm"
                   action="${pageContext.request.contextPath}/activity/edit/${activityForm.id}">
            ...
            <input type="submit" value="activity"/></td>
